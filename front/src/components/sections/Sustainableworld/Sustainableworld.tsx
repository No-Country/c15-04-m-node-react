		...
		<div className="md:flex bg-white shadow-lg rounded-lg p-4 x border border-gray-200 text-center flex-col md:flex-row">
			...
			<div className="md:flex-row justify-between w-25">
				...
				<p className="text-md text-left p-10">
					...
					gráficamente cuales son las actividades que mas CO2 generan y como puedes reducirlo. También vas a encontrar
					distintas actividades para poder ayudar y aportar para que todos tengamos un planeta mas sustentable. ¡Y
