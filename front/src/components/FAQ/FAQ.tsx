			...
			<div className="m-auto px-2 flex justify-between text-center">
                ...
                focus:text-green-500"
						...
						<AccordionContent>
							...
							más allá de la variabilidad natural, alterando la composición de la atmósfera global. La emisión de gases
							de efecto invernadero, producidos principalmente por la actividad humana, son el principal causante del
							cambio climático.
						</AccordionContent>
					</AccordionItem>
                ...
                focus:text-green-500"
						...
						<AccordionContent className="px-6">
							<ul className="list-disc ml-6 py-3 text-start">
								...
								<li className="py-2">
									<strong>Óxido nitroso (N2O):</strong> Producido principalmente en la agricultura intensiva, por el uso
									de fertilizantes nitrogenados. Las centrales térmicas, los motores de avión y los tubos de escape de
									los automóviles también provocan la emisión de estos gases.
								</li>
								<li>
									<strong>Clorofluorocarbonos (CFC):</strong> Se encuentran en pequeñas concentraciones, pero perjudican
									de forma potente. Se utilizan principalmente en procesos industriales, sistemas de refrigeración,
									aerosoles y aislantes eléctricos.
								</li>
							</ul>
						</AccordionContent>
					</AccordionItem>
                ...
                focus:text-green-500"
						...
						<AccordionContent className="px-2">
							...
							energía emitida de manera indirecta por las instalaciones o por la producción. El Alcance 3 tiene en
                ...
                focus:text-green-500"
						...
						<AccordionContent className="px-2">
							Es una iniciativa para fomentar la participación ciudadana con el objetivo de alargar la vida útil de los
							productos y promover el reciclaje. Este tipo de acciones logran reducir la huella de carbono individual y
