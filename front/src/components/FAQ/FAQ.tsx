		...
		<>
			<div className="pt-20 justify-center">
                ...
                focus:text-green-500"
							...
							<AccordionContent>
								Parte de la atmosfera con importantes reducciones del nivel de ozono debido a las emisiones emitidas por
								los humanos. Como consecuencia, hay un incremento de la radiación ultravioleta, perjudicial para los
								seres vivos.
							</AccordionContent>
						</AccordionItem>
                ...
                focus:text-green-500"
							...
							<AccordionContent>
								...
								<ul>
									<li>
										Dióxido de carbono (CO2). Es el más importante y asociado principalmente a las actividades humanas.
										Se debe al uso de la quema de combustibles fósiles en medios de transporte y procesos industriales,
										entre otros.
									</li>
									<li>
									...
									<li>
										Óxido nitroso (N2O). Producido principalmente en la agricultura intensiva, por el uso de
										fertilizantes nitrogenados. Las centrales térmicas, los motores de avión y los tubos de escape de
										los automóviles también provocan la emisión de estos gases.
									</li>
									<li>
										{" "}
										Clorofluorocarbonos (CFC). Se encuentran en pequeñas concentraciones, pero perjudican de forma
										potente. Se utiliza principalmente en procesos industriales, sistemas de refrigeración, aerosoles y
                ...
                focus:text-green-500"
							...
							<AccordionContent className="text">
								Iniciativa para fomentar la participación ciudadana con el objetivo de alargar la vida útil de los
								productos y promover el reciclaje. Este tipo de acciones logran reducir la huella de carbono individual
