      ...
      <body>
        <div className="hero flex flex-col items-center justify-center">
          ...
          <h3 className="text-lg p-2">
            ...
            exercitationem minus delectus, et neque recusandae odit distinctio.
            Repellat maxime suscipit mollitia pariatur soluta eligendi
            repudiandae vero debitis nobis id!
          </h3>
